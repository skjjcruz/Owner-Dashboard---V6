...
const LEGACY_UNUSED_VAR_NAMES = [
  ...
  "PICK_VALUES_BY_SLOT", "STATS_YEAR",
  "aValStyle", "activeLeagueId", "allAssessments", "baseSeason", "boughtBarWinner", "boughtBarYou",
  "brackets3", "budgetPct", "contract", "customDraftStrategy", "dKpiCardStyle",
  "dKpiLabel", "dKpiNum", "dhqColor", "diff", "dna",
  "draftGradeLetter", "draftSortIndicator", "draftStrategyEditing", "espnConnecting",
  "espnError", "faBudget", "faTargets", "giftLinks", "giftingFor",
  ...
  "hitRateLeagueItems", "isAnalyst", "isViewingMyTeam", "kpiCardStyle", "kpiDeltaStyle",
  ...
  "projClass", "projData", "pw2", "reconLeagueId", "reconUrl",
  "rivalries", "rosterLeagueCount", "rp", "saveGrudges", "scopeButtonStyle", "setAlexAvatar",
  "setBoardData", "setCustomDraftStrategy",
  "setDraftStrategyEditing", "setReconLeagueId", "setSelectedYear",
